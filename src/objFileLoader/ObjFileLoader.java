...
public class ObjFileLoader {
	...
	public static RawModel loadOBJ(String objFileName, Loader loader) {
		...
		return loader.loadToVAO(objFileName, verticesArray, texturesArray, normalsArray, indicesArray);
	}
	...
	private static float convertDataToArrays(List<Vertex> vertices, List<Vector2f> textures, List<Vector3f> normals,
		...
		for (int i = 0; i < vertices.size(); i++) {
			...
			Vector2f textureCoord = textures.get(currentVertex.getTextureIndex() == -1 ? currentVertex.getIndex() : currentVertex.getTextureIndex());
			Vector3f normalVector = normals.get(currentVertex.getNormalIndex() == -1 ? currentVertex.getIndex() : currentVertex.getNormalIndex());
